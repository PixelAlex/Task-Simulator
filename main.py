...
def pzadacha3():
    print('Задача 3. Напиши формулу по нахождению емкости конденсатора.')
    answer3 = str(input())
    answer3 = answer3.replace(' ', '')
    if answer3 == 'q/U' or answer3 == 'q:U' or answer3 == 'C=q/U' or answer3 == 'C=q:U' or answer3 == 'q/U=C' or answer3 == 'q:U=C':
        print('Молодец! Верно!\n')
    else:
        print('Неверно, попробуй еще раз\n')
        pzadacha3()
